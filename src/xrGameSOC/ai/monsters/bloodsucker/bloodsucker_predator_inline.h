...
{
	this->add_state	(eStatePredator_MoveToCover,	new CStateMonsterMoveToPointEx<_Object> (obj));
	this->add_state	(eStatePredator_LookOpenPlace,	new CStateMonsterLookToPoint<_Object> 	(obj));
	this->add_state	(eStatePredator_Camp,			new CStateMonsterCustomAction<_Object> 	(obj));
}
